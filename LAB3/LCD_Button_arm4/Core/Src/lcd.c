...
void lcd_draw_traffic_light_vertical_G(uint16_t x, uint16_t y, uint16_t width, uint16_t height) {
    lcd_draw_rectangle(x, y, x + width, y + height, 0x7BEF);
    lcd_fill(x, y, x + width, y + height, 0x7BEF);

    int r = width / 2 - 2;
    int cx = x + width / 2;
    int cy_red = y + r + 4;
    int cy_yellow = y + height / 2;
    int cy_green = y + height - r - 4;

    lcd_draw_circle(cx, cy_red, 0xFFFF, r, 1);
    lcd_draw_circle(cx, cy_yellow, 0xFFFF, r, 1);
    lcd_draw_circle(cx, cy_green, 0x07E0, r, 1);
}
void lcd_draw_traffic_light_vertical_Y(uint16_t x, uint16_t y, uint16_t width, uint16_t height) {
    lcd_draw_rectangle(x, y, x + width, y + height, 0x7BEF);
    lcd_fill(x, y, x + width, y + height, 0x7BEF);
    ...
    lcd_draw_circle(cx, cy_red, 0xFFFF, r, 1);
    lcd_draw_circle(cx, cy_yellow, 0xFFE0, r, 1);
    lcd_draw_circle(cx, cy_green, 0xFFFF, r, 1);
}

void lcd_draw_traffic_light_vertical_R(uint16_t x, uint16_t y, uint16_t width, uint16_t height) {
    lcd_draw_rectangle(x, y, x + width, y + height, 0x7BEF);
    lcd_fill(x, y, x + width, y + height, 0x7BEF);
    ...
    lcd_draw_circle(cx, cy_red, 0xF800, r, 1);
    lcd_draw_circle(cx, cy_yellow, 0xFFFF, r, 1);
    lcd_draw_circle(cx, cy_green, 0xFFFF, r, 1);
}

void lcd_draw_traffic_light_horizontal_G(uint16_t x, uint16_t y, uint16_t width, uint16_t height) {
    lcd_draw_rectangle(x, y, x + width, y + height, 0x7BEF);
    lcd_fill(x, y, x + width, y + height, 0x7BEF);
    ...
    int cy = y + height / 2;
    int cx_red = x + r + 4;
    int cx_yellow = x + width / 2;
    int cx_green = x + width - r - 4;

    lcd_draw_circle(cx_red, cy, 0xFFFF, r, 1);
    lcd_draw_circle(cx_yellow, cy, 0xFFFF, r, 1);
    lcd_draw_circle(cx_green, cy, 0x07E0, r, 1);
}

void lcd_draw_traffic_light_horizontal_Y(uint16_t x, uint16_t y, uint16_t width, uint16_t height) {
    lcd_draw_rectangle(x, y, x + width, y + height, 0x7BEF);
    lcd_fill(x, y, x + width, y + height, 0x7BEF);
    ...
    lcd_draw_circle(cx_red, cy, 0xFFFF, r, 1);
    lcd_draw_circle(cx_yellow, cy, 0xFFE0, r, 1);
    lcd_draw_circle(cx_green, cy, 0xFFFF, r, 1);
}

void lcd_draw_traffic_light_horizontal_R(uint16_t x, uint16_t y, uint16_t width, uint16_t height) {
    lcd_draw_rectangle(x, y, x + width, y + height, 0x7BEF);
    lcd_fill(x, y, x + width, y + height, 0x7BEF);
    ...
    int cx_yellow = x + width / 2;
    int cx_green = x + width - r - 4;
    lcd_draw_circle(cx_red, cy, 0xF800, r, 1);
	lcd_draw_circle(cx_yellow, cy, 0xFFFF, r, 1);
	lcd_draw_circle(cx_green, cy, 0xFFFF, r, 1);
}
...
void lcd_draw(int side, int color){
	if(side == 0){
		if(color == 1){
			lcd_draw_traffic_light_vertical_G(30, 100, 28, 90);
		}else if(color == 2){
			lcd_draw_traffic_light_vertical_Y(30, 100, 28, 90);
		}else if(color == 0){
			lcd_draw_traffic_light_vertical_R(30, 100, 28, 90);
		}
	}else if(side == 1){
		if(color == 1){
			lcd_draw_traffic_light_horizontal_G(30, 100, 28, 90);
		}else if(color == 2){
			lcd_draw_traffic_light_horizontal_Y(30, 100, 28, 90);
		}else if(color == 0){
			lcd_draw_traffic_light_horizontal_R(30, 100, 28, 90);
		}
	}
}
