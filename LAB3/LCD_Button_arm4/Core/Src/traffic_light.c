...
void fsm_normal(uint16_t system_timer){
	...
	led_7seg_set_digit(traffic_light_counter[LEFT_SIDE] / 10, 0, 0);
	led_7seg_set_digit(traffic_light_counter[LEFT_SIDE] % 10, 1, 0);
	led_7seg_set_digit(traffic_light_counter[RIGHT_SIDE] / 10, 2, 0);
	led_7seg_set_digit(traffic_light_counter[RIGHT_SIDE] % 10, 3, 0);
	led_7seg_set_colon(1);

	// Display on LED screen
	// Display mode
	lcd_show_string(50, 30, "NORMAL MODE", WHITE, RED, 24, 0);
	...
	for(int side = LEFT_SIDE; side <= RIGHT_SIDE; side++){
		...
		case RED_LIGHT:
			...
			lcd_draw_circle(traffic_light_led_coordinate[side][X_COR], traffic_light_led_coordinate[side][Y_COR], RED, 40, 1);
			lcd_show_int_num(traffic_light_number_coordinate[side][X_COR], traffic_light_number_coordinate[side][Y_COR], traffic_light_counter[side], 3, WHITE, RED, 24);
		...
		case GREEN_LIGHT:
			// Display traffic light led & number
			lcd_draw_circle(traffic_light_led_coordinate[side][X_COR], traffic_light_led_coordinate[side][Y_COR], GREEN, 40, 1);
			lcd_show_int_num(traffic_light_number_coordinate[side][X_COR], traffic_light_number_coordinate[side][Y_COR], traffic_light_counter[side], 3, BLACK, GREEN, 24);
		...
		case YELLOW_LIGHT:
			// Display traffic light led & number
			lcd_draw_circle(traffic_light_led_coordinate[side][X_COR], traffic_light_led_coordinate[side][Y_COR], YELLOW, 40, 1);
			lcd_show_int_num(traffic_light_number_coordinate[side][X_COR], traffic_light_number_coordinate[side][Y_COR], traffic_light_counter[side], 3, BLACK, YELLOW, 24);
...
void fsm_modify_light(uint16_t system_timer, uint8_t color){
	...
	led_7seg_set_digit((temp_max_counter / 10) % 10, 2, 0);
	led_7seg_set_digit(temp_max_counter % 10, 3, 0);
	led_7seg_set_colon(0);

	// Display mode
	switch(color){
		case RED_LIGHT:
			lcd_show_string(50, 30, "MODIFY RED", WHITE, RED, 24, 0);
			lcd_draw_circle(traffic_light_led_coordinate[LEFT_SIDE][X_COR], traffic_light_led_coordinate[LEFT_SIDE][Y_COR], RED, 40, 1);
			lcd_show_int_num(traffic_light_number_coordinate[RIGHT_SIDE][X_COR], traffic_light_number_coordinate[RIGHT_SIDE][Y_COR], temp_max_counter, 4, WHITE, RED, 24);
			break;
		case GREEN_LIGHT:
			lcd_show_string(50, 30, "NORMAL GREEN", BLACK, GREEN, 24, 0);
			lcd_draw_circle(traffic_light_led_coordinate[LEFT_SIDE][X_COR], traffic_light_led_coordinate[LEFT_SIDE][Y_COR], GREEN, 40, 1);
			lcd_show_int_num(traffic_light_number_coordinate[RIGHT_SIDE][X_COR], traffic_light_number_coordinate[RIGHT_SIDE][Y_COR], temp_max_counter, 4, BLACK, GREEN, 24);
			break;
		case YELLOW_LIGHT:
			lcd_show_string(50, 30, "NORMAL YELLOW", BLACK, YELLOW, 24, 0);
			lcd_draw_circle(traffic_light_led_coordinate[LEFT_SIDE][X_COR], traffic_light_led_coordinate[LEFT_SIDE][Y_COR], YELLOW, 40, 1);
			lcd_show_int_num(traffic_light_number_coordinate[RIGHT_SIDE][X_COR], traffic_light_number_coordinate[RIGHT_SIDE][Y_COR], temp_max_counter, 4, BLACK, YELLOW, 24);
			break;
	}
